...
export default function AfricaMapWithSVG() {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="relative h-full overflow-hidden rounded-lg border bg-gray-100">
        ...
        {/* Africa outline overlay - always visible, not affected by zoom */}
        <div className="absolute inset-0 z-20 pointer-events-none">
          <div className="w-full h-full flex items-center justify-center">
            <div className="relative w-[80%] h-[80%]">
              <Image
                src="/images/africa-outline.png"
